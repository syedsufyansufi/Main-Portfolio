...
// Import header image using a public URL instead of relative import
// Move header.jpg to public folder and reference it as "/header.jpg"
...
const Portfolio = () => {
 ...
 {
   title: "Chatty - MERN Chat App",
   description:
     "A real-time chat application with instant messaging, user authentication, and online/offline status indicators. Features include contact management, message history, and a modern dark-themed UI.",
   achievement: "Live on Render",
   tech: ["React.js", "Node.js", "Express", "MongoDB", "Socket.io", "JWT"],
   link: "https://mern-chatapp-b8dv.onrender.com/",
   github: "https://github.com/syedsufyansufi/Mern-ChatApp",
 },
]
        ...
        <div className="text-center z-10 max-w-4xl mx-auto px-4">
          ...
          >
            <div className="mb-8 flex flex-col items-center">
              {/* Use public folder for image - move header.jpg to public folder */}
              <img
                src="/header.jpg"
            ...
            <div className="flex flex-wrap justify-center gap-4 mb-12">
              ...
              <a
                href="https://drive.google.com/file/d/1EHLlt7yItkc1hPXDagtl10Js_DFSGCaN/view?usp=sharing"
                className="flex items-center gap-2 bg-white/10 backdrop-blur-sm px-6 py-3 rounded-full hover:bg-white/20 transition-all duration-300 hover:scale-105"
                target="_blank"
